program test_tnls_interior_interp_ab_probe
   ...
   call tnls(n, ind, n, x, m, lambda, rho, l, u, f, g, d, amax, 1, 1, 2.d0, 2.d0, 1, 5, -1.d0, 20, 0, 0, &
   ...
   deallocate(gxcar)
end program test_tnls_interior_interp_ab_probe
