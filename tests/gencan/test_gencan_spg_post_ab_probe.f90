program test_gencan_spg_post_ab_probe
   ...
   ! Force most variables onto active bounds to bias to the SPG path.
   do i = 2, n
      l(i) = x(i)
      u(i) = 1.d20
   end do
   ...
   call gencan(n, x, l, u, m, lambda, rho, 0.d0, 1.d-6, 5, 0.d0, maxitngp, &
      ...
      lastgpns, w, 0.1d0, 1.d-2, 1.d10, 1.d-10, 1.d-6, 1.d-4, 0.5d0, 0.1d0, &
...
end program test_gencan_spg_post_ab_probe
