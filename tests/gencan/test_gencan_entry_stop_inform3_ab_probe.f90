program test_gencan_entry_stop_inform3_ab_probe
   ...
   call gencan(n, x, l, u, m, lambda, rho, 0.d0, 0.d0, 2, 0.d0, maxitngp, &
      -1.d99, 20, 500, -1.d0, -1, 2, 1.d-6, 1.d-1, 1.d-5, 1.d-4, 5, .false., &
      ...
      0.9d0, 1.d-7, 1.d-10, 1.d-10, 1.d-20, 1.d20, 0.d0)
...
end program test_gencan_entry_stop_inform3_ab_probe
