program test_cg_nqmpstop_ab_probe
   ...
   call cg(n, ind, n, x, m, lambda, rho, g, 1.d0, l, u, 1.d-4, 1.d0, 1, 20, .false., 0, 1, 1, 0, n, s, iter, &
   ...
   deallocate(gxcar)
end program test_cg_nqmpstop_ab_probe
