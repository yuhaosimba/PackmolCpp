program test_tnls_nobound_interior_noextrap_ab_probe
   ...
   call tnls(n, ind, n, x, m, lambda, rho, l, u, f, g, d, amax, 0, 0, 2.d0, 2.d0, 1, 0, -1.d0, 20, 0, 0, &
      fcnt, gcnt, intcnt, exgcnt, exbcnt, inform, xplus, xtmp, xbext, 1.d-4, 0.5d0, 0.1d0, 0.9d0, &
   ...
   deallocate(gxcar)
end program test_tnls_nobound_interior_noextrap_ab_probe
