program test_tnls_nobound_interior_ex4_ab_probe
   ...
   call tnls(n, ind, n, x, m, lambda, rho, l, u, f, g, d, amax, 0, 0, 2.d0, 2.d0, 1, 4, -1.d0, 20, 0, 0, &
   ...
   deallocate(gxcar)
end program test_tnls_nobound_interior_ex4_ab_probe
