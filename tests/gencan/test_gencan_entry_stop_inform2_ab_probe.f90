program test_gencan_entry_stop_inform2_ab_probe
   ...
   call gencan(n, x, l, u, m, lambda, rho, 0.d0, 0.d0, 1, 1.d0, maxitngp, &
...
end program test_gencan_entry_stop_inform2_ab_probe
